...
public class FileKit {
	...
	private Logger logger = LoggerFactory.getLogger ( FileKit.class );
    ...
    public static  String getUploadDir(String fileUrl){
    	return getFileDir(JeePlusProperties.USERFILES_BASE_URL+ fileUrl);
    }
    ...
    public static String getWebappDir(){
        try {
            return ResourceUtils.getURL("classpath:").getPath().replace("/target/classes/", "/src/main/webapp/")+"/";
        } catch (FileNotFoundException e) {
            return JeePlusProperties.newInstance().getBaseDir()+"/";
        }
    }
