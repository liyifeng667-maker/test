...
import MonacoEditor from '@/datav/page/components/editor'
...
import { createFile } from '@/datav/utils/utils'
...
.screen-container {
  ...
  width: 5000px;
  height: 3000px;
  background: url("/datav/img/screen.png") repeat;
}
